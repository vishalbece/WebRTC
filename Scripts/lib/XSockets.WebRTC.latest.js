...
XSockets.RMediaRecorder = (function () {
    var Erecorder = function (stream, options) {
        var self = this;
        this.options = XSockets.Utils.extend(options || {}, {
            chunkSize: 500,
            mimeType: "video/webm", ignoreMutedMedia: false, recorderId: XSockets.Utils.guid()
    ...
    Erecorder.prototype.oncompleted = function () {
    };

    Erecorder.prototype.stop = function () {
        var mediaRecorder = this.mediaRecorder;
        mediaRecorder.stop();
    };


    Erecorder.prototype.blobs = [];
    Erecorder.prototype.start = function (stopafter) {
        this.blobs.length = 0;
        this.isRecording = true;
        var mediaRecorder = this.mediaRecorder;
        //var timeOut = window.setTimeout(function () {
    ...
    Erecorder.prototype.isRecording = false;
    return Erecorder;
